from learn_utils import read_float

"""
#输入一个数字，判断是否为正数、负数或零
num = read_float("请输入一个数字: ")
if num > 0:
    print("这是一个正数。")
elif num < 0:
    print("这是一个负数。")
...
a = read_float("请输入第一条边长: ")
b = read_float("请输入第二条边长: ")
c = read_float("请输入第三条边长: ")
...
num1 = read_float("请输入第一个数字: ")
oper = input("请输入运算符号:")
num2 = read_float("请输入第二个数:")
